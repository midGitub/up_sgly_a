...
public class GameLauncher
{
    ...
    static bool firstExist = false;
    static bool firstOut = false;

    static GameLauncher()
    {
        EditorApplication.playmodeStateChanged += ChangedPlaymodeState1;
        EditorApplication.playmodeStateChanged += ChangedPlaymodeState2;
        EditorApplication.playmodeStateChanged += ChangedPlaymodeState3;
    }

    public static Action OnFirstPlay;
    public static Action OnFirstExit;
    public static Action OnFirstOut;

    static void ChangedPlaymodeState1()
    {
        ...
        if (OnFirstExit != null)
            OnFirstExit();
        //Debug.Log("firstExist");
    }

    static void ChangedPlaymodeState2()
    {
        if (EditorApplication.isPaused)
        {
            return;
    ...
    static void ChangedPlaymodeState3()
    {
        if (EditorApplication.isPaused)
        {
            return;
