                ...
                if ((currentGraph.GetType() == typeof(FlowGraph) || currentGraph.GetType().IsSubclassOf(typeof(FlowGraph))) && GUIUtility.keyboardControl == 0)
                {
                    ...
                    if (e.keyCode == KeyCode.C && e.type == EventType.KeyUp && !e.control && !e.alt && !e.shift && GUIUtility.keyboardControl == 0)
                    {
                        ...
                        {   
                            ...
                            Framework.CanvasGroup group = new Framework.CanvasGroup(GetNodeBounds(node).ExpandBy(50f), "New Canvas Group");
                    ...
                    if (e.type == EventType.KeyUp && e.alt && e.control)
                    {
                        ...
                        if (e.keyCode == KeyCode.S)
                        {
                            ...
                            menu.AddItem(new GUIContent("SendEvent<T>"), false, D, new SendEvent<float>());
                            menu.AddSeparator("");
                            menu.AddItem(new GUIContent("Self"), false, S, new OwnerVariable());
                            menu.AddSeparator("");
                            menu.AddItem(new GUIContent("SwitchByIndex"), false, S, new Switch<float>());
                            menu.AddItem(new GUIContent("Switch Value"), false, D, new SwitchValue<float>());
                            menu.AddSeparator("");
                        ...
                        if (e.keyCode == KeyCode.C)
                        {
                            ...
                            var menu = new UnityEditor.GenericMenu();
                            menu.AddItem(new GUIContent("Cache"), false, D, new Cache<UnityEngine.Object>());
                            ...
                            menu.AddItem(new GUIContent("CustomEvent<T>"), false, S, new CustomEvent<float>());
                        ...
                        if (e.keyCode == KeyCode.D)
                        {
                            ...
                            menu.AddItem(new GUIContent("DummyValue"), false, D, new Identity<float>());
                        ...
                        if (e.keyCode == KeyCode.R)
                        {
                            ...
                            menu.AddSeparator("");
                            menu.AddItem(new GUIContent("RelayValueInput"), false, S, new RelayValueInput<float>());
                            menu.AddItem(new GUIContent("RelayValueOutput"), false, S, new RelayValueOutput<float>());
