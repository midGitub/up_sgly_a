...
public abstract class GestureRecognizerInspector<T> : Editor where T:GestureRecognizer
{
    ...
    //SerializedProperty m_gestureAction;

    private void OnEnable()
    {
        //m_gestureAction = serializedObject.FindProperty("gestureEvent");
    }
    protected virtual void OnMessagingUI()
    {
        ...
        //EditorGUILayout.PropertyField(m_gestureAction, true);
    ...
    public static void SetClipboard( string value )
    {
        ...
        PropertyInfo systemCopyBufferProperty = T.GetProperty("systemCopyBuffer", BindingFlags.Static | BindingFlags.Public );
