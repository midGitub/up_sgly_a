...
Shader "GW/Dissolve/DissolveTransit"  
{  
    Properties{  
            ...
            _DissolveThreshold("DissolveThreshold 0-1", Range(0,1)) = 0  
            _ColorFactor("ColorFactor 0-1", Range(0,1)) = 0.7  
            _DissolveEdge("DissolveEdge 0-1", Range(0,1)) = 0.8  

            _FlyThreshold("_FlyThreshold 0-10", Range(0,10)) = 0.8
            _FlyFactor("_FlyFactor 0-10", Range(0,10)) = 0.8
        }  
        ...
        {  
            ...
            return fixed4(colorOut, 0.5);
            
            //float lerpValue = (dissolveValue.r - _DissolveThreshold) * _DissolveEdge;  
            //fixed3 final = edgeColor + _DissolveColor * lerpValue;  
            //return fixed4(final, 0.5);  
        }  
        ENDCG  
