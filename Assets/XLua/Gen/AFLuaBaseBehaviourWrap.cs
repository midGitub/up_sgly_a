...
namespace XLua.CSObjectWrap
{
    ...
    public class AFLuaBaseBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "InitLuaData", _m_InitLuaData);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "BeRecover", _m_BeRecover);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_InitLuaData(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        XLua.LuaTable __cl_gen_ret = __cl_gen_to_be_invoked.InitLuaData(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_BeRecover(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.BeRecover(  );
