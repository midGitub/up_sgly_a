...
namespace Tacticsoft.Examples
{
    ...
    {
        public UnityEngine.Object m_cellPrefab;
        ...
        void Start() {
            ...
            m_tableView.SetCellPrefab("DynamicHeightCellInstance", m_cellPrefab);
        }
        ...
        public TableViewCell GetCellForRowInTableView(TableView tableView, int row) {
            DynamicHeightCell cell = tableView.GetReusableCell("DynamicHeightCellInstance") as DynamicHeightCell;
            //TableViewCell cell = tableView.GetReusableCell("DynamicHeightCellInstance") as TableViewCell;
            if (cell == null) {
                cell = (DynamicHeightCell)tableView.GetNewCell("DynamicHeightCellInstance");// GameObject.Instantiate(m_cellPrefab);
